...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('css/fullwidth/skin.css') }}">
...
<div class="page">
		...
		<div class="sticky-wrapp">
			<div class="sticky-container">
				...
				<section id="logo" class="logo">
					<div>
						<a href="{{ url('/') }}"><img src="{{ asset('img/green/logo.png') }}" alt="Clinico"></a>
					</div>
				</section>
				<!--/ logo -->
				...
				<nav class="main-nav">
					<ul>
						<li>
							...
							<ul>
								<li>
									<a href="{{ url('/') }}" class="active">Medical Style</a>
									<ul>
										<li class="text">
											<h2>Main Campus</h2>
											<hr>
											вулиця Такато <br>Бучач, Тернопільська область 265984
											<hr>
	...
	<section class="page-title">
		<div class="grid-row clearfix">
			...
			<nav class="bread-crumbs">
				<a href="{{ url('/') }}">Головна</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;
						...
						<div class="item">
							<ul>
								...
								<li>
									...
									<p><span class="date">Purus purus, tincidunt</span><br>Bmolestie ut eros. Fusce blandit, sapien eu sollicitudin consectetur.</p>
								</li>
							</ul>
						</div>
						<div class="item">
							<ul>
								...
								<li>
									<img src="pic/doctor-3.jpg" alt="">
									<p><span class="date">Fusce purus, tincidunt</span><br>Bmolestie ut eros. Fusce blandit, sapien eu sollicitudin consectetur.</p>
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="grid-col grid-col-3">
				...
				<section class="widget-alt recent-posts">
					...
					<ul>
						...
						<li>
							<a href="#"><img src="{{ asset('pic/post/2.png') }}" width="80" height="80" alt=""></a>
	...
	<!-- copyrights -->
	<div class="copyrights">Copyrights ©2018: Оксана Кулик - Responsive Medical and Health Template</div>
	<!--/ copyrights -->
...
<script type="text/javascript" src="{{ asset('js/TimelineMax.min.js') }}"></script>
<!--/ Superscrollorama -->
...
<script type="text/javascript" src="{{ asset('js/jquery-ui-tabs-rotate.js') }}"></script>
